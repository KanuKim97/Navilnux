...
#define FFUART_ADDR  0x40100000
#define STUART_ADDR  0x40700000

#ifdef IN_GUMSTIX
static volatile Word *UART = (volatile Word *) FFUART_ADDR; // See FFUART def. It causes initilazer error베이스베이스 어드레스 
#else
static volatile Word *UART = (volatile Word *) STUART_ADDR; // UART 베이스 어드레스 
#endif
